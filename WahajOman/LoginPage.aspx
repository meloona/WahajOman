<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LoginPage.aspx.cs" Inherits="WahajOman.LoginPage" Async="true" %>
					...
					<div class="col-lg-6 form-group" style="left: 0px; top: 0px; width: 92%; height: 404px" >
                        ...
                        <br />
                         <table align="center">
                              <tr>
                                <td>
                                    <asp:Image runat="server" src="img/user-3.png" height="26px" width="30px" />
                                </td>
                                <td>
                                    <asp:TextBox ID="username" runat="server"   BackColor="White" CssClass="edittextpading" placeholder="اسم المستخدم"></asp:TextBox>
                                </td>
                             </tr>
                          </table>
                            <br />
                            <table align="center">
                                <tr>
                                    <td>
                                      <asp:Image runat="server" src="img/lock.png" height="26px" width="30px" />
                                    </td>
                                    <td>
                                      <asp:TextBox ID="pass" runat="server" TextMode="Password" BackColor="White" CssClass="edittextpading" placeholder="كلمة المرور" ></asp:TextBox>
                                    </td>
                                 </tr>
                            </table>
                             <br />
                         <table align="center" class="auto-style11">
                             <tr align="center">
                                 <td colspan="2">
                                      <asp:Button runat="server" CssClass="button" Text="تسجيل الدخول" OnClick="Register_Click" Width="156px"  />
                                 </td>
                             </tr>
                             <tr align="center">
                                 <td colspan="2">
                                      <asp:Button runat="server" Text="هل نسيت كلمة المرور؟" CssClass="auto-style"   onclick="Forget_Password" ></asp:Button>
                                 </td>
                             </tr>
                             <tr align="center">
                                 <td colspan="2">
