<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="WahajOman.Registration" Async="true" %>
        ...
        <div  class="divexms">
            <div class="auto4">
                 <table align="center" class="autotable">
                     ...
                     <tr>
                         <td class="auto-style38"><asp:Image runat="server" src="img/user-3.png" height="30px" class="auto-style46"/></td>
                         <td class="auto-style39"><asp:TextBox ID="username" runat="server" Height="36px" Width="217px" BackColor="White" CssClass="edittextpading" placeHolder="اسم المستخدم" ></asp:TextBox></td>
                         <td class="auto-style38"><asp:RequiredFieldValidator ID="RequiredFieldValidator5" 
                     ...
                     <tr>
                         <td class="auto-style49"> <asp:Image runat="server" src="img/email.png" height="26px" width="30px" CssClass="auto-style51" /></td>
                         <td class="auto-style48"><asp:TextBox ID="email" runat="server" Height="36px" Width="217px" TextMode="Email" BackColor="White" CssClass="edittextpading" placeHolder=" البريد الإلكتروني"></asp:TextBox></td>
                         <td class="auto-style49"><asp:RequiredFieldValidator 
                     ...
                     <tr>
                         <td style="text-align:center;" colspan="3">
                             <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="email" Font-Bold="True" CssClass="validation"
                              ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*" ErrorMessage="البريد الالكتروني غير صحيح" ForeColor="Red" />
                         </td>
                     </tr>
                     <tr>
                         <td class="auto-style42"><asp:Image runat="server" src="img/placeholder.png" height="31px" width="30px" CssClass="auto-style51"/></td>
                         <td class="auto-style37"><asp:TextBox ID="address" runat="server" Height="36px" Width="217px" BackColor="White" CssClass="edittextpading" PlaceHolder="الموقع"></asp:TextBox>  </td>
                     ...
                     <tr>
                         <td style="margin-bottom:10px;" colspan="2"> 
                             <asp:Label runat="server" Text="المواد الدراسية" /><br />
                                <asp:CheckBoxList id="CheckBoxList1" runat="server"  ForeColor="Black" Font-Size="Medium" Font-Bold="True" Height="26px" Width="142px" BackColor="#eaeaea"  CssClass=" auto-style30" >
                         ...
                         <td class="auto-style36"><asp:CustomValidator runat="server" ID="cvmodulelist"
                                                ClientValidationFunction="ValidateModuleList1"
                                                ErrorMessage="يجب أن تختار المواد الدراسية" 
                                                Font-Bold="True" ForeColor="Red" CssClass="validation">
            ...
            <div class="auto3">
                <table align="center" class="autotable">
                    <tr>
                         ...
                         <td class="auto-style35"><asp:TextBox ID="pass" runat="server" Height="36px" Width="217px" TextMode="Password" BackColor="White" CssClass="edittextpading" placeHolder="كلمة المرور"></asp:TextBox></td>
                    ...
                    <tr>
                     ...
                     <tr>
                         <td class="auto-style34"><asp:Image runat="server" src="img/lock.png" height="26px" width="30px" CssClass="auto-style51" /></td>
                         <td class="auto-style35"><asp:TextBox ID="repass" runat="server" Height="36px" Width="217px" TextMode="Password" BackColor="White" CssClass="edittextpading" placeHolder="تأكيد كلمة المرور"></asp:TextBox></td>
                    ...
                    <tr>
                     ...
                     <tr>
                          <td colspan="2" align="center" class="auto-style43">
                             <asp:Label runat="server"  Text="الصفوف" /><br />
                            <asp:CheckBoxList id="CheckBoxList2" runat="server"  ForeColor="Black" Font-Size="Medium" Font-Bold="True" Height="26px" Width="132px"  BackColor="#eaeaea" CssClass="auto-style30" >
                         ...
                         <td class="auto-style43">
                             <asp:CustomValidator runat="server" ID="CustomValidator1"
                                ...
                                ErrorMessage="يجب أن تختار الصفوف" 
                                Font-Bold="True" ForeColor="Red" CssClass="validation">
                            </asp:CustomValidator>
                         </td>
                      ...
                      <tr>
                         <td align="left" colspan="3" class="auto-style44">
                            <asp:Button runat="server" CssClass="auto-style26" Text="إرسال" OnClick="Register_Click" meta:resourcekey="ButtonResource1" Width="290px" />
                         </td>
                     </tr>
                 </table>
            </div>
