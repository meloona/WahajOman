...
namespace WahajOman
{
    public partial class SchoolDefault : System.Web.UI.Page
    {
        ...
        protected async void GetData(string username)
        {
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    {
                        name.Text = result.SchoolName;
                        name1.Text = result.SchoolName;
                        ...
                        type.Text = result.ServiceType;
                        type1.Text = result.ServiceType;
            ...
            while (true)
            {
                ...
                try
                {
                    if (Label1.Text == user1)
                    {
                        ...
                        var data = new Data
                        {
                            SchoolName = name1.Text,
                            Email = email1.Text,
                            Phone = phone1.Text,
                            Address = address1.Text,
                            ServiceType = type1.Text,
