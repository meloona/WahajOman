<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Teacher.aspx.cs" Inherits="WahajOman.Teacher" Async="true" %>
                                      ...
                                      <table  class="auto-style71">
                                          <tr>
                                              <td class="auto-style83">
                                                  <asp:Label ID="phone" runat="server" Font-Size="Medium" ForeColor="Black" Text='<%# Eval("المادة","{0}") %>'></asp:Label>
                                              </td>
                                              <td class="auto-style77">
                                                  <asp:Label ID="Label1" runat="server" CssClass="divlable" Font-Bold="true" Text=":المادة"></asp:Label>
                                              </td>
                                              <td class="auto-style81">
                                                  <asp:Label ID="name" runat="server" Font-Size="Medium" ForeColor="Black" Text='<%# Eval("اسم","{0}") %>' ></asp:Label>
                                              </td>
                                              <td class="auto-style79">
                                                  <asp:Label ID="Label2" runat="server" CssClass="divlable" Font-Bold="true" Text=":اسم المدرس"></asp:Label>
                                              </td>
                                          </tr>
                                          <tr>
