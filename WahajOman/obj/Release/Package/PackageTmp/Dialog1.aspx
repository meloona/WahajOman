<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dialog1.aspx.cs" Inherits="WahajOman.Dialog1" %>
                   ...
                   <table align="center" >
                       <tr>
                           <td align="center" class="auto-style48">    
                             <h1><asp:Label runat="server" CssClass="labeltext" Text=" سيتم إرسال بياناتك إلى البريد الإلكتروني  "  Font-Bold="true"></asp:Label></h1>
                            </td>
                       </tr>
                       <tr>
                           <td align="center" class="auto-style48">
                             <h1> <asp:Label runat="server" CssClass="labeltext"  Text="  الخاص  بالشركة لإستكمال إجراءات التسجيل الخاصة بك"  Font-Bold="true"></asp:Label></h1>
                           </td>
                       </tr>
                       <tr>
                           <td align="center" class="auto-style48">
