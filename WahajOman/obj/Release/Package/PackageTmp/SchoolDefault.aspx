<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolDefault.aspx.cs" Inherits="WahajOman.SchoolDefault" Async="true" %>
                                  ...
                                  <table>
                                      <tr>
                                          ...
                                          <td class="auto-style99">
                                             <asp:Label runat="server" Text=" :اسم المدرسة" Font-Size="Large" ForeColor="Black" Font-Bold="True" CssClass="labels"></asp:Label>  
                                          </td>
                                       </tr>
                                  </table>
                             </td>
                         ...
                         <tr> 
                                   ...
                                   <table>
                                      <tr>
                                          <td class="auto-style97" >
                                                <asp:Label ID="type" runat="server" Height="26px" Width="217px" Text="type" CssClass="label" ForeColor="GrayText" ></asp:Label>
                                                <asp:TextBox ID="type1" TextMode="MultiLine" Columns="5" runat="server" Height="87px" Width="238px" BackColor="White" CssClass="auto-style28" Visible="false" ></asp:TextBox>
                                          </td>
                                          <td class="auto-style99">
                                             <asp:Label runat="server" Text="    :الخدمات" Font-Size="Large" ForeColor="Black" Font-Bold="True" CssClass="labels"></asp:Label>       
                                          </td>
                                       </tr>
                                  </table>
                              </td>  
                          ...
                          <tr>
                               <td colspan="2" class="auto-style85">
                                    ...
                                    <asp:Label ID="state" runat="server"  Height="26px" Width="217px" CssClass="label"  ForeColor="GrayText" Visible="False"></asp:Label>
